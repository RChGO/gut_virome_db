...
find Temp/GPD* |awk '{print "blastn -query "$0" -db GPD_sequences.fa -out "$0".m8 -outfmt 6 -evalue 1e-10 -num_alignments 999999 -word_size 16 -num_threads 20"}' |split -d -l 25 - Temp/r1.sh ; find Temp/r1.sh* | awk '{print "nohup sh "$0" &"}' |sh
